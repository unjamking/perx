    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: C.bg }} edges={["top"]}>
      <View style={s.topbar}>
        <View>
          ...
          <Text style={s.sub}>Welcome back to Perx</Text>
        </View>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 120 }}>
        ...
        {liveNotifs.length > 0 && (
          <Animated.View entering={FadeInUp} style={s.notifBanner}>
        ...
        {feed.recommended.length > 0 && (
          <View style={s.section}>
            <SectionHeader title={feed.topCategory ? `For you · ${feed.topCategory}` : "Recommended"} />
        ...
        {feed.featured.map((o) => (
          <View key={o.id} style={s.section}>
            <Animated.View entering={FadeInUp} style={s.hero}>
              <Text style={s.heroBadge}>⭐ FEATURED</Text>
              ...
              <View style={s.heroFoot}>
                ...
                <Pressable style={s.heroBtn} onPress={() => cart.add(o)}>
                  <Text style={s.heroBtnText}>Add to cart</Text>
                </Pressable>
              </View>
            </Animated.View>
          </View>
        ...
        {feed.deals.length > 0 && (
          <View style={s.section}>
            <SectionHeader title="🔥 New Deals" action="Explore" onAction={() => navigation.navigate("Explore")} />
            <View style={{ gap: 12 }}>
              {feed.deals.map((o) => (
