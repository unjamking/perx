...
const STRINGS = {
  en: {
    ...
    noRecurring: "No auto-renewing benefits. Tap 🔄 on an offer to subscribe.",
    ...
    exodusGreeting: "Hi! I'm Exodus, your Perx concierge. Tell me what you're after — relaxing, fitness, food, travel — and your budget. 🌊",
    ...
    categoryPrefs: "⚙️ Category Preferences",
    ...
    joinChallenge: "Join Challenge", noChallenges: "No active challenges.",
  ...
  sq: {
    ...
    noRecurring: "Asnjë përfitim që rinovohet. Prek 🔄 te një ofertë për t'u abonuar.",
    ...
    exodusGreeting: "Përshëndetje! Jam Exodus, konçierxhi yt te Perx. Më thuaj çfarë kërkon — relaks, fitnes, ushqim, udhëtim — dhe buxhetin tënd. 🌊",
    ...
    categoryPrefs: "⚙️ Preferencat e kategorive",
    ...
    joinChallenge: "Bashkohu në sfidë", noChallenges: "Asnjë sfidë aktive.",
